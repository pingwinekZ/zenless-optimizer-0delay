...
const {
  core_dark_abyss_reverb,
  m1_dark_abyss_reverb,
  normal_enemy,
  charged_shot_hit,
  ex_special_daze_inc,
} = allBoolConditionals(key, undefined, {
  m1_dark_abyss_reverb: 1,
  charged_shot_hit: 4,
})
...
const sheet = register(
  ...
  registerBuff(
    'core_crit_',
    ownBuff.combat.crit_.add(core_dark_abyss_reverb.ifOn(dm.core.crit_))
  ),
  registerBuff(
    'core_crit_dmg_',
    ownBuff.combat.crit_dmg_.add(core_dark_abyss_reverb.ifOn(dm.core.crit_dmg_))
  ),
  registerBuff(
    'core_atk',
  ...
  registerBuff(
    ...
    ownBuff.combat.dazeInc_.addWithDmgType(
      'exSpecial',
      ex_special_daze_inc.ifOn(isStunned.ifOff(dm.core.dazeInc_))
    )
  ),
  registerBuff(
    'ability_chain_dmg_',
  ...
  registerBuff(
    ...
    ownBuff.combat.crit_.addWithDmgType(
      'exSpecial',
      isStunned.ifOn(m1_dark_abyss_reverb.ifOn(dm.m1.crit_))
    )
  ),
  registerBuff(
    ...
    ownBuff.combat.crit_dmg_.addWithDmgType(
      'exSpecial',
      isStunned.ifOn(m1_dark_abyss_reverb.ifOn(dm.m1.crit_dmg_))
    )
  ),
  registerBuff(
    'm1_ult_crit_',
