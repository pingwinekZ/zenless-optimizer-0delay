...
const { ability_ice_attacks, potential_ice_attacks } = allNumConditionals(
  key,
  true,
  0,
  dm.ability.stacks,
  undefined,
  { ability_ice_attacks: 0, potential_ice_attacks: 0 }
)
...
const sheet = register(
  ...
  registerBuff(
    ...
    ownBuff.combat.dmg_.ice.add(
      ability_check(prod(ability_ice_attacks, percent(dm.ability.ice_dmg_)))
    )
  ),
  registerBuff(
    'ability_crit_dmg_',
