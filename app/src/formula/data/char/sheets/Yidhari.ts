...
const { etherVeil, m4EtherVeil, erudition, abilityMissingHp } =
...
const sheet = register(
  ...
  registerBuff(
    ...
    ownBuff.combat.crit_dmg_.add(
      cmpGE(
        ...
        1,
        abilityMissingHp.ifOn(percent(dm.ability.crit_dmg_))
      )
    )
  ),
  registerBuff(
  ...
  registerBuff(
    ...
    ownBuff.combat.hp_.add(
      cmpGE(char.mindscape, 4, m4EtherVeil.ifOn(percent(dm.m4.hp_)))
    )
  ),
  registerBuff(
    'm6_sheer_dmg_',
