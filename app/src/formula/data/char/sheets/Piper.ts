...
const sheet = register(
  ...
  registerBuff(
    ...
    teamBuff.combat.common_dmg_.add(
      // Ability check: another teammate is Anomaly, or shares attribute or faction.
      // team.common.count includes self — she contributes 3 (1 anomaly + 1 physical
      // + 1 faction), so threshold >= 4 means "self + at least 1 qualifying teammate".
      cmpGE(
        sum(
