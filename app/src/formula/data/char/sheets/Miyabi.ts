...
const { ult_used, disorder_triggered, polar } = allBoolConditionals(
  key,
  undefined,
  { polar: 6 }
)
...
// Ability check: another teammate is Support or Anomaly, or same faction.
// team.common.count includes self — she contributes 2 (1 anomaly + 1 faction),
// so threshold >= 3 means "self + at least 1 qualifying teammate".
