...
const {
  darkbreaker,
  etherVeil,
  dreamersNurseryRhyme,
  exSpecialState,
  m1DreamersNurseryRhyme,
  m2EtherVeil,
  m2Darkbreaker,
  m6EtherVeil,
} = allBoolConditionals(key, undefined, {
  m1DreamersNurseryRhyme: 1,
  m2Darkbreaker: 2,
  m2EtherVeil: 2,
  m6EtherVeil: 6,
})
...
const m2_harmony_dmg_ = ownBuff.combat.common_dmg_.add(
  cmpGE(char.mindscape, 2, m2EtherVeil.ifOn(percent(dm.m2.harmony_dmg_)))
)
const harmony_crit_ = ownBuff.combat.crit_.add(
  cmpGE(char.mindscape, 6, m6EtherVeil.ifOn(percent(1)))
)
const harmony_crit_dmg_ = ownBuff.combat.crit_dmg_.add(
  cmpGE(char.mindscape, 6, m6EtherVeil.ifOn(percent(dm.m6.harmony_crit_dmg_)))
)
  ...
  registerBuff(
    ...
    teamBuff.combat.resIgn_.add(
      cmpGE(
        char.mindscape,
        1,
        m1DreamersNurseryRhyme.ifOn(percent(dm.m1.resIgn_))
      )
    ),
    undefined,
    true
  ...
  registerBuff(
    ...
    teamBuff.combat.sheer_dmg_.add(
      cmpGE(
        char.mindscape,
        2,
        m2Darkbreaker.ifOn(m2EtherVeil.ifOn(percent(dm.m2.sheer_dmg_)))
      )
    ),
    undefined,
    true
  ...
  registerBuff(
    ...
    ownBuff.combat.atk.add(
      cmpGE(
        char.mindscape,
        6,
        m6EtherVeil.ifOn(prod(own.initial.hp, percent(dm.m6.atk_)))
      )
    )
  ),
