 ...
 * notify gated hooks, which then check their snapshots and only re-render
 * if their selected value actually changed.
 *
 * Ported from hsr-optimizer's `lib/hooks/useTabVisibility.ts`.
 */
export const TabVisibilityContext =
  createContext<TabVisibilityValue>(defaultValue)
