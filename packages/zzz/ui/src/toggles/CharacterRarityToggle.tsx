...
import { rarityDefIcon } from '@zenless-optimizer/zzz/assets'
import type { CharacterRarityKey } from '@zenless-optimizer/zzz/consts'
import { allCharacterRarityKeys } from '@zenless-optimizer/zzz/consts'
